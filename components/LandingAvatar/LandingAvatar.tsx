...
function LandingAvatar({ hovered }: Props) {
  return (
    <svg
      width="264px"
      height="280px"
            ...
            >
              ...
              >
                ...
                <mask id="react-mask-174" fill="white">
                  <use xlinkHref="#react-path-173"></use>
                </mask>
                <use
                  id="Hoodie"
                  fill="#B7C1DB"
                  fillRule="evenodd"
                  xlinkHref="#react-path-173"
                ></use>
                <g
                  id="Color/Palette/Gray-01"
                  mask="url(#react-mask-174)"
                  fillRule="evenodd"
                  fill="#3C4F5C"
                >
              ...
              >
                {hovered ? (
                  ...
                  >
                    ...
                    <mask id="react-mask-218" fill="white">
                      <use xlinkHref="#react-path-217"></use>
                    </mask>
                    <use
                      id="Mouth"
              ...
              <g id="Top" strokeWidth="1" fillRule="evenodd">
                ...
                <mask id="react-mask-141" fill="white">
                  <use xlinkHref="#react-path-143"></use>
                </mask>
                <g id="Mask"></g>
                <g id="Top/Short-Hair/Short-Flat" mask="url(#react-mask-141)">
                  <g transform="translate(-1.000000, 0.000000)">
                    <mask id="react-mask-140" fill="white">
                      <use xlinkHref="#react-path-142"></use>
                    </mask>
                    <use
                      id="Short-Hair"
                      stroke="none"
                      fill="#1F3140"
                      fillRule="evenodd"
                      xlinkHref="#react-path-142"
                    ></use>
                    <g
                      id="Skin/👶🏽-03-Brown"
                      mask="url(#react-mask-140)"
                      fill="#2C1B18"
                    >
                      <g transform="translate(0.000000, 0.000000) " id="Color">
                        <rect x="0" y="0" width="264" height="280"></rect>
